...
error = []
t0 = time()
image_array_sample = shuffle(image_array, random_state=randomstate)[:1000]
...
codebook_random = shuffle(image_array, random_state=randomstate)[:n_colors + 1]
